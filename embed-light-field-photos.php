...
preg_match_all("/(http:\/\/)(www.lytro.com|lytro.com)(\/living-pictures\/)(.*)/", $text, $matches, PREG_SET_ORDER);
...
?>
   <div class="wrap">
   	<h2><?php _e('Embed Light-Field Photos', HI_TEXTDOMAIN); ?></h2>
<br />
Thank you for using Embed Light Field Photos plugin. Visit <a href="http://www.lightfieldphotobook.com" target="_blank">www.lightfieldphotobook.com</a> for more light field photography related news, information and free services.
   </div>
<?php
}

function embed_light_field_photo_admin_menu() {
   add_options_page(__('Light-Field Photos', HI_TEXTDOMAIN), __('Light-Field Photos', HI_TEXTDOMAIN), 'manage_options', basename(__FILE__), 'embed_light_field_photo_options_page');
}
